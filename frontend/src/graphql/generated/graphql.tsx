...
export type BookingsQuery = {
  ...
  allBookings: Array<{
    ...
    tickets: Array<{ __typename?: 'Ticket'; seatNo: number }>;
  }>;
};
...
export type CreateEventMutation = {
  __typename?: 'Mutation';
  createEvent: { __typename?: 'Event'; id: string };
};
...
export type EventSeatAvailabilityQuery = {
  __typename?: 'Query';
  eventSeatAvailability: {
    __typename?: 'EventSeatAvailability';
    eventId: number;
    seatNos: Array<number>;
 ...
 * });
 */
export function useArtistListQuery(
  baseOptions?: Apollo.QueryHookOptions<
    ArtistListQuery,
    ArtistListQueryVariables
  >
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useQuery<ArtistListQuery, ArtistListQueryVariables>(
    ArtistListDocument,
    options
  );
}
export function useArtistListLazyQuery(
  ...
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useLazyQuery<ArtistListQuery, ArtistListQueryVariables>(
    ArtistListDocument,
    options
  );
}
export function useArtistListSuspenseQuery(
  baseOptions?:
    | Apollo.SkipToken
    | Apollo.SuspenseQueryHookOptions<ArtistListQuery, ArtistListQueryVariables>
) {
  const options =
    baseOptions === Apollo.skipToken
      ? baseOptions
      : { ...defaultOptions, ...baseOptions };
  return Apollo.useSuspenseQuery<ArtistListQuery, ArtistListQueryVariables>(
    ArtistListDocument,
    options
  );
}
export type ArtistListQueryHookResult = ReturnType<typeof useArtistListQuery>;
export type ArtistListLazyQueryHookResult = ReturnType<
  typeof useArtistListLazyQuery
>;
export type ArtistListSuspenseQueryHookResult = ReturnType<
  typeof useArtistListSuspenseQuery
>;
export type ArtistListQueryResult = Apollo.QueryResult<
  ArtistListQuery,
  ArtistListQueryVariables
>;
...
export function useBookingsSuspenseQuery(
  baseOptions?:
    | Apollo.SkipToken
    | Apollo.SuspenseQueryHookOptions<BookingsQuery, BookingsQueryVariables>
) {
  const options =
    baseOptions === Apollo.skipToken
      ? baseOptions
      : { ...defaultOptions, ...baseOptions };
  return Apollo.useSuspenseQuery<BookingsQuery, BookingsQueryVariables>(
    BookingsDocument,
    options
  );
}
...
>;
export type BookingsSuspenseQueryHookResult = ReturnType<
  typeof useBookingsSuspenseQuery
>;
...
export function useEventByIdQuery(
  ...
  > &
    ({ variables: EventByIdQueryVariables; skip?: boolean } | { skip: boolean })
) {
  const options = { ...defaultOptions, ...baseOptions };
...
export function useEventByIdSuspenseQuery(
  baseOptions?:
    | Apollo.SkipToken
    | Apollo.SuspenseQueryHookOptions<EventByIdQuery, EventByIdQueryVariables>
) {
  const options =
    baseOptions === Apollo.skipToken
      ? baseOptions
      : { ...defaultOptions, ...baseOptions };
  return Apollo.useSuspenseQuery<EventByIdQuery, EventByIdQueryVariables>(
    EventByIdDocument,
    options
  );
}
 ...
 * });
 */
export function useEventSeatAvailabilityQuery(
  baseOptions: Apollo.QueryHookOptions<
    EventSeatAvailabilityQuery,
    EventSeatAvailabilityQueryVariables
  > &
    (
      | { variables: EventSeatAvailabilityQueryVariables; skip?: boolean }
      | { skip: boolean }
    )
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useQuery<
    EventSeatAvailabilityQuery,
    EventSeatAvailabilityQueryVariables
  >(EventSeatAvailabilityDocument, options);
}
export function useEventSeatAvailabilityLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<
    EventSeatAvailabilityQuery,
    EventSeatAvailabilityQueryVariables
  >
...
export function useEventSeatAvailabilitySuspenseQuery(
  baseOptions?:
    | Apollo.SkipToken
...
export type EventSeatAvailabilityQueryHookResult = ReturnType<
  typeof useEventSeatAvailabilityQuery
>;
export type EventSeatAvailabilityLazyQueryHookResult = ReturnType<
  typeof useEventSeatAvailabilityLazyQuery
>;
export type EventSeatAvailabilitySuspenseQueryHookResult = ReturnType<
  typeof useEventSeatAvailabilitySuspenseQuery
>;
export type EventSeatAvailabilityQueryResult = Apollo.QueryResult<
  EventSeatAvailabilityQuery,
  EventSeatAvailabilityQueryVariables
>;
 ...
 * });
 */
export function useVenueListQuery(
  baseOptions?: Apollo.QueryHookOptions<VenueListQuery, VenueListQueryVariables>
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useQuery<VenueListQuery, VenueListQueryVariables>(
    VenueListDocument,
    options
  );
}
export function useVenueListLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<
    VenueListQuery,
    VenueListQueryVariables
  >
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useLazyQuery<VenueListQuery, VenueListQueryVariables>(
    VenueListDocument,
    options
  );
}
export function useVenueListSuspenseQuery(
  baseOptions?:
    | Apollo.SkipToken
    | Apollo.SuspenseQueryHookOptions<VenueListQuery, VenueListQueryVariables>
) {
  const options =
    baseOptions === Apollo.skipToken
      ? baseOptions
      : { ...defaultOptions, ...baseOptions };
  return Apollo.useSuspenseQuery<VenueListQuery, VenueListQueryVariables>(
    VenueListDocument,
    options
  );
}
export type VenueListQueryHookResult = ReturnType<typeof useVenueListQuery>;
export type VenueListLazyQueryHookResult = ReturnType<
  typeof useVenueListLazyQuery
>;
export type VenueListSuspenseQueryHookResult = ReturnType<
  typeof useVenueListSuspenseQuery
>;
export type VenueListQueryResult = Apollo.QueryResult<
  VenueListQuery,
  VenueListQueryVariables
>;
